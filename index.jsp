                ...
                <li>
                  <img src="img/slider/3.jpg" alt="img">
                   <div class="slider_caption slider_right_caption">
                    ...
                    <p>It is a long established fact that Learning is a lifelong process that extends beyond the classroom. <br>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="aboutus_area wow fadeInLeft">
            ...
            <p>It is a long established fact that Learning is a lifelong process that extends beyond the classroom. <br>
 So, why restrict yourself to traditional settings?  that it has a more-or-less normal distribution of content.</div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <li>
                    <div class="media">
                      ...
                      <div class="media-body">
                       <a href="#">Learning is a lifelong process that extends beyond the classroom.</a>
              ...
              <ul class="course_nav">
                <li>
                  <div class="single_course">
                    ...
                    <h3 class="singCourse_title"><a href="#">Polycet</a></h3>
                ...
                <li>
                  <div class="single_course">
                    ...
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="#">ECET</a></h3>
                    <p class="singCourse_price"><span>2000</span> Per One Month</p>
                    <p>Learning is a lifelong process that extends beyond the classroom</p>
                    </div>
                    <div class="singCourse_author">
                ...
                <li>
                  <div class="single_tutors">
                    ...
                    <div class="singTutors_content">
                      <h3 class="tutors_name">Teacher</h3>
